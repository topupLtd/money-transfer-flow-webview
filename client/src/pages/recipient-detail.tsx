...
import { ChevronLeft, Landmark, Wallet, User, Phone, MapPin, Users, ChevronDown, Trash2, Save } from "lucide-react";
...
export default function RecipientDetail() {
  ...
  // Find which country we are in (mocking based on recipient ID)
  // In a real app we'd fetch the recipient and its country
  ...
  const providers = COUNTRY_PROVIDERS[selectedCountryCode as keyof typeof COUNTRY_PROVIDERS] || {
    ...
    banks: ["Ecobank", "Standard Chartered", "United Bank for Africa"]
  };
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 px-1">
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Input defaultValue="Lagos" className="h-12 border-none bg-gray-100 rounded-xl font-semibold focus-visible:ring-1 focus-visible:ring-primary/20" />
                    </div>
                    <div className="space-y-2">
                      <Input defaultValue="Ikeja" className="h-12 border-none bg-gray-100 rounded-xl font-semibold focus-visible:ring-1 focus-visible:ring-primary/20" />
                    </div>
                  </div>
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-2">
                      <Input defaultValue="100001" className="h-12 border-none bg-gray-100 rounded-xl font-semibold focus-visible:ring-1 focus-visible:ring-primary/20" />
                    </div>
                    <div className="space-y-2">
                      <Input defaultValue="123 Example Street" className="h-12 border-none bg-gray-100 rounded-xl font-semibold focus-visible:ring-1 focus-visible:ring-primary/20" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4 px-1">
                <div className="space-y-2">
                  ...
                  <Select defaultValue="zenith bank">
                    <SelectTrigger className="h-12 border-none bg-gray-100 rounded-xl font-semibold focus:ring-1 focus:ring-primary/20">
                ...
                {isIndia && (
                  <div className="space-y-2">
                    ...
                    <Input defaultValue="SBIN0001234" className="h-12 border-none bg-gray-100 rounded-xl font-semibold focus-visible:ring-1 focus-visible:ring-primary/20" />
                  </div>
                )}
                ...
                <div className="space-y-2">
                  ...
                  <Input defaultValue="08012345678" className="h-12 border-none bg-gray-100 rounded-xl font-semibold focus-visible:ring-1 focus-visible:ring-primary/20" />
                </div>
              </div>
            </div>
          </TabsContent>
