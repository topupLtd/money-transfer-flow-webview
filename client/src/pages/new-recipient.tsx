...
export default function NewRecipient() {
  ...
  const addCurrentAccount = (type: 'bank' | 'wallet') => {
    // This is a mockup, so we just add a dummy entry
    const newAccount = {
      id: Date.now(),
      type,
          ...
          <Card className="p-5 space-y-4 border-gray-100">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input placeholder="John" className="h-11 border-none bg-gray-50 rounded-xl font-semibold" />
              </div>
              <div className="space-y-2">
                <Label className="text-[10px] font-bold text-gray-400 uppercase">Last Name</Label>
                <Input placeholder="Doe" className="h-11 border-none bg-gray-50 rounded-xl font-semibold" />
              </div>
            </div>
            <div className="space-y-2">
