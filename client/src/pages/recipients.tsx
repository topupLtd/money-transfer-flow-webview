    ...
    <MobileLayout title="Select Recipient">
      <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
        ...
        <div className="relative">
          ...
          <Input placeholder="Search name, email, or account" className="pl-9 bg-white h-12 rounded-xl" />
        </div>
        ...
        <div className="space-y-3">
          <h3 className="font-semibold text-gray-900 ml-1">Recent Recipients</h3>
          ...
          <div className="space-y-2">
            {recipients.map((recipient) => (
              <div 
                ...
                className="flex items-center gap-4 p-4 rounded-xl bg-white border border-gray-100 shadow-sm hover:border-primary/50 cursor-pointer transition-all active:scale-[0.98]"
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500">{recipient.bank} • {recipient.account}</p>
                </div>
              </div>
            ))}
          </div>
